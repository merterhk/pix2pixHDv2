...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='pix2pixHDv2', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--fp16', action='store_true',  help='train with AMP')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/example')
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='global_upsample', help='selects model to use for netG [global|global_upsample|global_pixelshuffle|global_espcn]')
        ...
        self.parser.add_argument('--g1_residual', type=str, default='resnet', help='Residual blocks [resnet|convnext|convnextv2]')
